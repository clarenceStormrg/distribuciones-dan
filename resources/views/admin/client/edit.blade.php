    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Actualización de Cliente</h3>
        ...
        <form action="{{ route('client.update', $data->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="street_address" name="street_address" placeholder="Enter Direccion" value="{{ $data->street_address }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="location_lat" name="location_lat" value="{{ $data->location_lat }}" readonly required>
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Longitud</label>
                <input type="text" class="form-control" id="location_lng" name="location_lng" value="{{ $data->location_lng }}" readonly required>
            </div>
            ...
            if(navigator.geolocation) { 
                navigator.geolocation.getCurrentPosition(
                    function(position) { 
                        ...
                        map.setCenter(new google.maps.LatLng($("#location_lat").val(),$("#location_lng").val())); 
                    }, 
                    function() { 
            ...
            google.maps.event.addListener(map, "bounds_changed", 
                function(event) { 
                    if (!centreGot) { 
                        ...
                        //marker_0.setOptions({ position: new google.maps.LatLng(mapCentre.lat(), mapCentre.lng()) }); // posicion actual
                        marker_0.setOptions({ position: new google.maps.LatLng($("#location_lat").val(), $("#location_lng").val()) });
                    } 
                        centreGot = true; }); 
