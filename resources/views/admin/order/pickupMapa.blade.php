    ...
    <div class="modal fade" id="modalMaps" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <p style="font-weight: bold; font-size: 1.3rem;">Nota: Las rutas se ordenar de manera númerica, siendo el punto 1 el almacen y el resto de puntos los lugares de reparto</p>
            </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript"> //<![CDATA[ 
        ...
        arr.forEach((item) => 
        {
            ...
            let objPoligon = {lat:parseFloat(arr2[0]),lng:parseFloat(arr2[1])};
            listMark.push(objMaps);
            listPoligon.push(objPoligon);
        });

        console.log(listPoligon);
        /*const beaches = [
